...
import com.example.edive.adapter.RlvCommentListAdapter;
...
public class CommentActivity extends BaseMvpActivity<PersonModel> {
    ...
    private RlvCommentListAdapter adapter;
    private int type = 3;
    private int num = 1;
    private int size = 10;
    ...
    public void initView() {
        ...
        adapter = new RlvCommentListAdapter(CommentActivity.this, list);
        ...
        adapter.setonclick(new RlvCommentListAdapter.setonclick() {
            @Override
            public void setonclick(int pos) {
                ...
                Intent intent = new Intent(CommentActivity.this, DynamicDetailsActivity.class);
