...
import com.example.edive.adapter.ImageGridAdapter;
import com.example.edive.bean.ImageItem;
import com.example.edive.local_utils.AlbumHelper;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        bt.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                if (Bimp.act_bool)
                {
                    Intent intent = new Intent(ImageGridActivity.this, PublishDynamicActivity.class);
