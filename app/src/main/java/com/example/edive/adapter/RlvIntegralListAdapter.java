...
public class RlvIntegralListAdapter extends RecyclerView.Adapter<RlvIntegralListAdapter.ViewHolder> {
    private final FragmentActivity activity;
    private final ArrayList<IntegralListBean.ResultBean.ListBean> list;
    private setonclick time;
    private setonclickss timess;

    public RlvIntegralListAdapter(FragmentActivity activity, ArrayList<IntegralListBean.ResultBean.ListBean> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(activity).inflate(R.layout.item_integral_order, null);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int i) {
        ...
        double productPrice = list.get(i).getProductPrice();
    ...
    public interface setonclickss{
        void setonclickss(int pos);
    }
    public void setonclickss(setonclickss timess){
