...
public class RlvMyDynamicDetailsAdapter extends RecyclerView.Adapter<RlvMyDynamicDetailsAdapter.ViewHolder> {
    ...
    public RlvMyDynamicDetailsAdapter(Context activity, ArrayList<MyDynamicBean.DataBean.ListBean> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View inflate = LayoutInflater.from(activity).inflate(R.layout.item_mydynamicdetails_top, null);
