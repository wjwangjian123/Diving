package com.example.edive.design.banner;
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        if (mSelectedDrawable == null) {
            ...
            selectedGradientDrawable.setColor(Color.BLACK);
            selectedGradientDrawable.setSize(dp2px(4), dp2px(4));
            selectedGradientDrawable.setCornerRadius(dp2px(4) / 2);
        ...
        if (mUnselectedDrawable == null) {
            ...
            unSelectedGradientDrawable.setCornerRadius(dp2px(4) / 2);
        ...
        LayoutParams vpLayoutParams = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
